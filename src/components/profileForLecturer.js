...
import MenuForLecturer from "./menuForLecturer";

export default function ProfileForLecturer() {
  const history = useHistory();
  const EditPro = () => {
    history.push("/editprofileforlecturer");
  };

  return (
    <div className="profileforlecturer">
      <MenuForLecturer />
            ...
            <div className="position-info">
              <div className="row">
                ...
                <div className="col-lg-3 ">
                  ...
                  <h4 className="proPosition">Technical Officier</h4>
                </div>
