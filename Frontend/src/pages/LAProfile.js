...
export default function LAProfile() {
  const history = useHistory();
  const LAEditPro = () => {
    history.push("/LAEditProfile");
  };

  return (
    <div className="LAProfile">
      <LASidebar />
      ...
      <div className="content-wrapper">
        <div className="card card-primary">
          ...
          <div className="card-body ">
              ...
              <div className="position-info">
                <div className="row">
                  ...
                  <div className="col-lg-3 ">
                    ...
                    <h4 className="proPosition">Lab Attendant</h4>
                  </div>
            ...
            <center>
              <button className="btn btn-primary" onClick={LAEditPro}>
                Edit My Profile
              </button>
            </center>
          </div>
